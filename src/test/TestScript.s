#    TestScript.s
#
#    RISC-V Assembly script containing a main procedure to run and test 
#    binarySearch.
#
#    @author Dr. Qi Han
    ...
    getValues:
        ...
        getValuesLoop:
            ...
            add a0, zero, t4                # Copies buffer address to a0
             li a7, 4                       # Print null-terminated string
            ecall
            li a7, 5                        # Read int from console
            ecall
            mv t2, a0                       # Place syscall rv into given reg
